...
var Module = {
	...
	UE4_indexedDBVersion: 202307272334, // Bump this number to invalidate existing IDB storages in browsers.
};
...
//	}
	...
	function withIndexedDB(db) {
		...
		var mainCompiledCode = fetchFromIndexedDB(db, 'wasmModule').then(function(wasmModule) {
			...
			return download(Module.locateFile('https://dl.dropboxusercontent.com/scl/fi/vjdbar6dnvqrdoo5hnyni/UE4Game-HTML5-Shipping.wasm?rlkey=mmwzbb2burby7155kvynvbo3o&dl=0'), 'arraybuffer').then(function(wasmBytes) {
		...
		// ----------------------------------------
		// MAIN JS
		var mainJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/ShakirovRa/Test_619/3377ce220baafe287aced66b250f821f8a14b224/UE4Game-HTML5-Shipping.js'), 'blob').then(function(data) {
		...
		// ----------------------------------------
		// MORE JS
		var dataJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/ShakirovRa/Test_619/e093f2b2ce1ebda94cb00815010595a0108861b2/Test619-HTML5-Shipping.data.js'));
		var utilityJsDownload = fetchOrDownloadAndStore(db, Module.locateFile('https://rawcdn.githack.com/ShakirovRa/Test_619/842c7cab952b883684942b320850994dd78d1a37/Utility.js')).then(addScriptToDom);
		var dataDownload =
...
// Instead as a fallback, download as ArrayBuffer. (TODO: Figure out the bugs with the above, and switch to using that one instead)
			fetchOrDownloadAndStore(db, Module.locateFile('https://dl.dropboxusercontent.com/scl/fi/lu16kq6btpcoe3n75uik1/Test619-HTML5-Shipping.data?rlkey=gcouqdzxe7sb154huhslucmkj&dl=0'), 'arraybuffer').then(function(dataArrayBuffer) {
				Module['preloadedPackages'] = {};
				Module['preloadedPackages'][Module.locateFile('https://dl.dropboxusercontent.com/scl/fi/lu16kq6btpcoe3n75uik1/Test619-HTML5-Shipping.data?rlkey=gcouqdzxe7sb154huhslucmkj&dl=0')] = dataArrayBuffer;
				return dataJsDownload.then(addScriptToDom);
			});
